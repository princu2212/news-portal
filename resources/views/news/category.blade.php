                        ...
                        @foreach($articles as $item)
                            <article
                                ...
                                <div class="p-5 flex-1 flex flex-col justify-between space-y-3">
                                    <div>
                                        <div
                                            class="flex justify-between items-center text-[10px] text-gray-400 font-bold uppercase mb-1">
                                            <span>{{ $item->district ? $item->district->name . ' बुलेटिन' : $item->author_name }}</span>
                                        </div>
                                        <h3
                                            class="text-base font-bold text-gray-900 hover:text-brand-red line-clamp-2 leading-snug">
                                    ...
                                    <div
                                        ...
                                        <a href="{{ route('news.show', $item->slug) }}"
                                            class="font-bold text-brand-red hover:underline">पूरा पढ़ें &rarr;</a>
                                    </div>
                                </div>
                            </article>
                        @endforeach
